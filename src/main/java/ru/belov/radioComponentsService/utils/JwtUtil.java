package ru.belov.radioComponentsService.utils;
...
public class JwtUtil {
    ...
    public static String generateAccessToken(MyUser user) {
    ...
    private static Map<String, Object> generateAccessClaims(MyUser user){
    ...
    public static String generateRefreshToken(MyUser user) {
        long nowMillis = System.currentTimeMillis();
        Date now = new Date(nowMillis);
    ...
    private static Map<String, Object> generateRefreshClaims(MyUser user){
        Map<String, Object> claims = new HashMap<>();
